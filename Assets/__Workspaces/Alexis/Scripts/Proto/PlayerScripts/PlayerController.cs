...
namespace __Workspaces.Alexis.Scripts.Proto.PlayerScripts
{
    public class PlayerController : MonoBehaviour
    {
        ...
        void DoLocomotion()
        {
            _rb.linearVelocity = new Vector2(Move.x * PlayerData.MoveSpeed * Time.deltaTime, _rb.linearVelocity.y);
        }
        ...
        {
            _rb.linearVelocity = new Vector2(Move.x * PlayerData.MoveSpeed * Time.deltaTime / 2, _jetpackForce);
        }
